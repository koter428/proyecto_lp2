 ...
 * @author jeferzon
 */
public class rpt_articulo extends javax.swing.JDialog {
    conectbd con;
    ResultSet rs, rs1;
    /**
     * Creates new form rpt_marca
     */
    public rpt_articulo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        con = new conectbd();
        con.conectar();
    ...
    public void llenar_combo(){
        try {
            ...
            if(rs.isBeforeFirst()){
                while(rs.next()){
                    desdecodigo.addItem(rs.getString("art_cod"));
                    hastacodigo.addItem(rs.getString("art_cod"));
                    desdedescri.addItem(rs.getString("art_descri"));
                    hastadescri.addItem(rs.getString("art_descri"));
                }
            }
        } catch (SQLException ex) {
            Logger.getLogger(rpt_articulo.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    public void generarreporte() {
        try {
            ...
            if (optcodigo.isSelected()) {
                rs1 = con.listar_datos("select * from v_articulo where art_cod between "+desdecodigo.getSelectedItem()+" and "
                        + hastacodigo.getSelectedItem());
            }else{
                rs1 = con.listar_datos("select * from v_articulo where art_descri between '"+desdedescri.getSelectedItem()+"' and '"
        ...
        try{
            URL urlMaestro = getClass().getClassLoader().getResource("reportes/articulo.jasper");
            // Cargamos el reporte
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rpt_articulo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                rpt_articulo dialog = new rpt_articulo(new javax.swing.JFrame(), true);
