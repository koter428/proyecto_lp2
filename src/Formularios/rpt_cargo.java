 ...
 * @author jeferzon
 */
public class rpt_cargo extends javax.swing.JDialog {
    conectbd con;
    ResultSet rs, rs1;
    /**
     * Creates new form rpt_marca
     */
    public rpt_cargo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        con = new conectbd();
        con.conectar();
    ...
    public void llenar_combo(){
        try {
            rs = con.listar_datos("select * from cargo order by car_cod");
            if(rs.isBeforeFirst()){
                while(rs.next()){
                    desdecodigo.addItem(rs.getString("car_cod"));
                    hastacodigo.addItem(rs.getString("car_cod"));
                    desdedescri.addItem(rs.getString("car_descri"));
                    hastadescri.addItem(rs.getString("car_descri"));
                }
            }
        } catch (SQLException ex) {
            Logger.getLogger(rpt_cargo.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    public void generarreporte() {
        try {
            ...
            if (optcodigo.isSelected()) {
                rs1 = con.listar_datos("select * from cargo where car_cod between "+desdecodigo.getSelectedItem()+" and "
                        + hastacodigo.getSelectedItem());
            }else{
                rs1 = con.listar_datos("select * from cargo where car_descri between '"+desdedescri.getSelectedItem()+"' and '"
        ...
        try{
            URL urlMaestro = getClass().getClassLoader().getResource("reportes/cargo.jasper");
            // Cargamos el reporte
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rpt_cargo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                rpt_cargo dialog = new rpt_cargo(new javax.swing.JFrame(), true);
