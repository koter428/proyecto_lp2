 ...
 * @author jeferzon
 */
public class rpt_proveedor extends javax.swing.JDialog {
    conectbd con;
    ResultSet rs, rs1;
    /**
     * Creates new form rpt_marca
     */
    public rpt_proveedor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        con = new conectbd();
        con.conectar();
    ...
    public void llenar_combo(){
        try {
            rs = con.listar_datos("select * from proveedor order by prv_cod");
            if(rs.isBeforeFirst()){
                while(rs.next()){
                    desdecodigo.addItem(rs.getString("prv_cod"));
                    hastacodigo.addItem(rs.getString("prv_cod"));
                    desdedescri.addItem(rs.getString("prv_razonsocial"));
                    hastadescri.addItem(rs.getString("prv_razonsocial"));
                }
            }
        } catch (SQLException ex) {
            Logger.getLogger(rpt_proveedor.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    public void generarreporte() {
        try {
            ...
            if (optcodigo.isSelected()) {
                rs1 = con.listar_datos("select * from proveedor where prv_cod between "+desdecodigo.getSelectedItem()+" and "
                        + hastacodigo.getSelectedItem());
            }else{
                rs1 = con.listar_datos("select * from proveedor where prv_razonsocial between '"+desdedescri.getSelectedItem()+"' and '"
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rpt_proveedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                rpt_proveedor dialog = new rpt_proveedor(new javax.swing.JFrame(), true);
