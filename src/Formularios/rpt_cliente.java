...
public class rpt_cliente extends javax.swing.JDialog {
    ...
    public void llenar_combo(){
        try {
            rs = con.listar_datos("select * from clientes order by cli_cod");
            if(rs.isBeforeFirst()){
                while(rs.next()){
                    desdecodigo.addItem(rs.getString("cli_cod"));
                    hastacodigo.addItem(rs.getString("cli_cod"));
                    desdedescri.addItem(rs.getString("cli_nombre"));
                    hastadescri.addItem(rs.getString("cli_nombre"));
                }
            }
    ...
    public void generarreporte() {
        try {
            ...
            if (optcodigo.isSelected()) {
                rs1 = con.listar_datos("select * from clientes where cli_cod between "+desdecodigo.getSelectedItem()+" and "
                        + hastacodigo.getSelectedItem());
            }else{
                rs1 = con.listar_datos("select * from clientes where cli_nombre between '"+desdedescri.getSelectedItem()+"' and '"
        ...
        try{
            URL urlMaestro = getClass().getClassLoader().getResource("reportes/cliente.jasper");
            // Cargamos el reporte
