 ...
 * @author jeferzon
 */
public class rpt_tipo_impuesto extends javax.swing.JDialog {
    conectbd con;
    ResultSet rs, rs1;
    /**
     * Creates new form rpt_marca
     */
    public rpt_tipo_impuesto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        con = new conectbd();
        con.conectar();
    ...
    public void llenar_combo(){
        try {
            rs = con.listar_datos("select * from tipo_impuesto order by tipo_cod");
            if(rs.isBeforeFirst()){
                while(rs.next()){
                    desdecodigo.addItem(rs.getString("tipo_cod"));
                    hastacodigo.addItem(rs.getString("tipo_cod"));
                    desdedescri.addItem(rs.getString("tipo_descri"));
                    hastadescri.addItem(rs.getString("tipo_descri"));
                }
            }
        } catch (SQLException ex) {
            Logger.getLogger(rpt_tipo_impuesto.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    public void generarreporte() {
        try {
            ...
            if (optcodigo.isSelected()) {
                rs1 = con.listar_datos("select * from tipo_impuesto where tipo_cod between "+desdecodigo.getSelectedItem()+" and "
                        + hastacodigo.getSelectedItem());
            }else{
                rs1 = con.listar_datos("select * from tipo_impuesto where tipo_descri between '"+desdedescri.getSelectedItem()+"' and '"
        ...
        try{
            URL urlMaestro = getClass().getClassLoader().getResource("reportes/tipo_impuesto.jasper");
            // Cargamos el reporte
    ...
    private void initComponents() {
        ...
        setTitle("Reporte de Tipo de Impuesto");
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rpt_tipo_impuesto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                rpt_tipo_impuesto dialog = new rpt_tipo_impuesto(new javax.swing.JFrame(), true);
